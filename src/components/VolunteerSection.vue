...
const submitVolunteer = async () => {
  ...
  try {
    await axios.post('http://127.0.0.1:8000/api/volunteer-submit', volunteerForm.value)
...
<template>
    ...
    <div class="container mx-auto px-4">
      <div class="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div
          ...
          <div class="space-y-3">
            <div class="h-10 bg-gray-200 dark:bg-gray-700 rounded w-full"></div> <!-- Name -->

            <div class="grid grid-cols-2 gap-3">
              <div class="h-10 bg-gray-200 dark:bg-gray-700 rounded w-full"></div> <!-- Phone -->
              <div class="h-10 bg-gray-200 dark:bg-gray-700 rounded w-full"></div> <!-- Area -->
            </div>

            <div class="h-10 bg-gray-200 dark:bg-gray-700 rounded w-full"></div> <!-- Email -->
            <div class="h-20 bg-gray-200 dark:bg-gray-700 rounded w-full"></div> <!-- Address -->

            <div class="h-12 bg-gray-300 dark:bg-gray-600 rounded w-full mt-2"></div> <!-- Button -->
          </div>
        </div>
  ...
  <section v-else
    ...
    <!-- Decorative Circle -->
    <div class="absolute top-0 right-0 w-64 h-64 bg-white opacity-10 rounded-full -mr-20 -mt-20 pointer-events-none">
    </div>
    <div class="absolute bottom-0 left-0 w-40 h-40 bg-white opacity-10 rounded-full -ml-10 -mb-10 pointer-events-none">
    </div>
    ...
    <div class="container mx-auto px-4 relative z-10">
      <div class="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="text-center md:text-left">
          <h2 class="text-3xl md:text-5xl font-bold mb-6 leading-tight">দেশ ও দশের সেবায়<br>আমাদের সাথে যোগ দিন</h2>
          <p class="text-green-100 text-lg mb-8">স্বেচ্ছাসেবক হিসেবে যোগ দিয়ে সিরাজগঞ্জের উন্নয়নে আপনিও ভূমিকা রাখতে
            পারেন। আজই রেজিস্ট্রেশন করুন।</p>
        ...
        <div
          ...
          <h3 class="text-2xl font-bold mb-4 text-center text-green-700 dark:text-green-400">স্বেচ্ছাসেবক রেজিস্ট্রেশন
          </h3>

          <form @submit.prevent="submitVolunteer" class="space-y-3">
            <input v-model="volunteerForm.name" type="text" placeholder="আপনার নাম" required
            ...
            <div class="grid grid-cols-2 gap-3">
              <input v-model="volunteerForm.phone" type="text" placeholder="মোবাইল নম্বর" required
                class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 outline-none dark:bg-gray-700 dark:border-gray-600 dark:text-white">
              <input v-model="volunteerForm.interested_area" type="text" placeholder="আগ্রহী এলাকা"
                class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 outline-none dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            </div>

            <input v-model="volunteerForm.email" type="email" placeholder="ইমেইল (যদি থাকে)"
              class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 outline-none dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            <textarea v-model="volunteerForm.address" rows="2" placeholder="আপনার ঠিকানা"
              class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 outline-none dark:bg-gray-700 dark:border-gray-600 dark:text-white"></textarea>
