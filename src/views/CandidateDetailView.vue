...
onMounted(async () => {
    try {
        const response = await axios.get(`http://127.0.0.1:8000/api/candidate/${route.params.id}`)
...
<template>
    ...
    <div class="bg-gray-50 dark:bg-gray-900 min-h-screen flex flex-col transition-colors duration-300">
        ...
        <div v-if="loading" class="animate-pulse container mx-auto px-4 py-12 flex-grow">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden mb-8 border border-transparent dark:border-gray-700">
                <div class="md:flex">
                    <!-- Left: Profile Skeleton -->
                    <div class="md:w-1/3 bg-gray-200 dark:bg-gray-700 p-8 flex flex-col items-center justify-center h-[400px]">
                        <div class="w-48 h-48 bg-gray-300 dark:bg-gray-600 rounded-full mb-6 border-4 border-white dark:border-gray-600"></div>
            ...
            <!-- Biography Skeleton -->
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 md:p-12 border border-transparent dark:border-gray-700">
        ...
        <div v-else-if="candidate" class="container mx-auto px-4 py-12 flex-grow">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden mb-8 border border-transparent dark:border-gray-700 transition-colors">
                <div class="md:flex">
                    ...
                    <div
                        ...
                        <div class="relative mb-6">
                            <!-- Candidate Image -->
                            <div class="inline-flex items-center justify-center rounded-full border-8 border-white dark:border-gray-300">
                                <div class="rounded-full p-1 bg-gradient-to-r from-red-500 to-orange-500">
                                    <img :src="candidate.photo_url || 'https://placehold.co/300x300'"
                    ...
                    <!-- Right: Video -->
                    <div class="md:w-2/3 p-8">
                        <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-6 border-b dark:border-gray-700 pb-2">পরিচিতি ভিডিও</h2>

                        <div v-if="candidate.video_link"
                            class="aspect-video rounded-lg overflow-hidden bg-black shadow-lg">
                            <iframe class="w-full h-full" :src="getEmbedUrl(candidate.video_link)" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                        </div>
                        <div v-else class="h-64 bg-gray-100 dark:bg-gray-700 flex items-center justify-center rounded-lg text-gray-400 dark:text-gray-500">
            ...
            <!-- Biography Section -->
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 md:p-12 border border-transparent dark:border-gray-700 transition-colors">
                ...
                <div class="prose prose-lg max-w-none text-gray-700 dark:text-gray-300 leading-relaxed text-justify"
                    v-html="candidate.biography"></div>
