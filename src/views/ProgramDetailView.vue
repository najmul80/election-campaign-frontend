...
onMounted(async () => {
    try {
        const response = await axios.get(`http://127.0.0.1:8000/api/program/${route.params.id}`)
        ...
        <div v-if="loading" class="container mx-auto px-4 py-12 flex-grow animate-pulse">
            <div
                ...
                <div class="h-64 md:h-96 bg-gray-300 dark:bg-gray-700 relative">
                    <div class="absolute top-6 right-6 h-16 w-24 bg-gray-400 dark:bg-gray-600 rounded-lg"></div>
                </div>
                ...
                <div class="p-8 md:p-12">
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-8 flex justify-between items-center">
        ...
        <div v-else-if="program" class="container mx-auto px-4 py-12 flex-grow">
            ...
            <div
                ...
                <div class="h-64 md:h-96 relative">
                    <img :src="program.image || 'https://placehold.co/800x400?text=Event'" :alt="program.title"
                ...
                <div class="p-8 md:p-12">
                    ...
                    <h1 class="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-6">{{ program.title }}
                    </h1>
