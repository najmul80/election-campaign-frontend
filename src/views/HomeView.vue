...
<template>
  ...
  <div class="bg-gray-50 dark:bg-gray-900 min-h-screen flex flex-col transition-colors duration-300">
    ...
    <main class="flex-grow">
      ...
      <CandidateSection :candidates="store.candidates" :common-symbol="store.settings?.logo" :loading="store.loading" />
    ...
    <div
      ...
      <a href="#candidates" @click="store.navigateToSection('candidates')"
